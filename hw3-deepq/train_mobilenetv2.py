...
def get_optimizer(params):
    ...
    notes:
        don't modify params
    """
    optimizer = torch.optim.Adam(params, lr=0.0001, betas=(0.9, 0.999), eps=1e-08, weight_decay=0, amsgrad=True)
    return optimizer
...
def before_batch(train_history, validation_history):
    ...
    """
    return {"optimizer": {"lr": 0.0001}, "batch_norm": 0.25, "drop_out":0.5}
